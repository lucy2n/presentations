...
function useSyncDemo(options) {
  ...
  const schemaOpts = (0, import_tldraw.useShallowObjectIdentity)(_schemaOpts);
  const schemaOptsWithDefaults = (0, import_react.useMemo)(() => {
    if ("schema" in schemaOpts && schemaOpts.schema) return schemaOpts;
    return {
      ...schemaOpts,
      shapeUtils: "shapeUtils" in schemaOpts ? [...import_tldraw.defaultShapeUtils, ...schemaOpts.shapeUtils ?? []] : import_tldraw.defaultShapeUtils,
      bindingUtils: "bindingUtils" in schemaOpts ? [...import_tldraw.defaultBindingUtils, ...schemaOpts.bindingUtils ?? []] : import_tldraw.defaultBindingUtils
    };
  }, [schemaOpts]);
