import {
  ...
  useValue,
  warnOnce
} from "./chunk-XIX4XEZ3.js";
import "./chunk-HR6WGPOL.js";
import "./chunk-ZMB5PWZ4.js";
import "./chunk-KKICQ5MC.js";
import {
  __publicField,
  __toESM,
  require_react
...
var TLSyncClient = class {
  constructor(config) {
    ...
    __publicField(this, "onSyncError");
    ...
    this.disposables.push(
      ...
      this.store.listen(
        ({ changes }) => {
          var _a;
          if ((_a = this.didCancel) == null ? void 0 : _a.call(this)) return this.close();
  ...
  didReconnect(event) {
    ...
    transact(() => {
      ...
      this.store.ensureStoreIsUsable();
      (_a = this.onAfterConnect) == null ? void 0 : _a.call(this, this, false);
    });
...
var ClientWebSocketAdapter = class {
  ...
  _handleDisconnect(reason, closeCode, didOpen) {
...
var TLSyncRoom = class {
  constructor(opts) {
    ...
    if (didIncrementClock) {
      (_a = opts.onDataChange) == null ? void 0 : _a.call(opts);
    }
  }
  close() {
    this.disposables.forEach((d) => d());
  ...
  handleNewSession(sessionId, socket, meta) {
    ...
    this.sessions.set(sessionId, {
      ...
      sessionId,
      socket,
      presenceId: (existing == null ? void 0 : existing.presenceId) ?? this.presenceType.createId(),
    ...
    transaction((rollback) => {
      ...
      const fail = (reason) => {
        ...
        if (typeof process !== "undefined" && true) {
          (_b = (_a2 = this.log) == null ? void 0 : _a2.error) == null ? void 0 : _b.call(_a2, "failed to apply push", reason, message);
        }
...
var TLSocketRoom = class {
  ...
  handleSocketMessage(sessionId, message) {
    ...
    try {
      ...
      const socket = (_h = this.sessions.get(sessionId)) == null ? void 0 : _h.socket;
      if (socket) {
        socket.send(
          JSON.stringify({
            type: "error",
            error: typeof (e == null ? void 0 : e.toString) === "function" ? e.toString() : e
          })
        );
        socket.close();
      }
...
function useSync(opts) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const client = new TLSyncClient({
      ...
      onLoadError(err) {
        track == null ? void 0 : track(MULTIPLAYER_EVENT_NAME, { name: "load-error", roomId });
        console.error(err);
        setState({ error: err });
      },
      onSyncError(reason) {
        track == null ? void 0 : track(MULTIPLAYER_EVENT_NAME, { name: "sync-error", roomId, reason });
...
function useSyncDemo(options) {
  ...
  const schemaOptsWithDefaults = (0, import_react2.useMemo)(() => {
    if ("schema" in schemaOpts && schemaOpts.schema) return schemaOpts;
    return {
      ...schemaOpts,
      shapeUtils: "shapeUtils" in schemaOpts ? [...defaultShapeUtils, ...schemaOpts.shapeUtils ?? []] : defaultShapeUtils,
      bindingUtils: "bindingUtils" in schemaOpts ? [...defaultBindingUtils, ...schemaOpts.bindingUtils ?? []] : defaultBindingUtils
    };
  }, [schemaOpts]);
  return useSync({
  ...
  return {
    ...
    resolve(asset, context) {
      ...
      if (MediaHelpers.isAnimatedImageType(asset == null ? void 0 : asset.props.mimeType) || asset.props.isAnimated)
        return asset.props.src;
      if (MediaHelpers.isVectorImageType(asset == null ? void 0 : asset.props.mimeType)) return asset.props.src;
